  ...
  const features = [
    {
      ...
      description: "Visual maps showing exactly where users click and how far they scroll on each page.",
      color: "analytics-blue",
    },
    {
      icon: Target,
      title: "Funnel Analysis",
      description: "Track user flows and identify where visitors drop off in your conversion process.",
      color: "analytics-orange",
    },
    {
      icon: Zap,
      title: "Real-Time Dashboard",
      description: "Live insights with filters, alerts, and comprehensive data visualizations.",
      color: "analytics-teal",
    },
    {
      icon: Download,
      title: "Export & Integration",
      description: "Export data in multiple formats and integrate with your existing tools.",
      color: "analytics-purple",
    },
    {
      icon: Code,
      title: "Easy Installation",
      description: "One script tag and you're ready to go. No complex setup required.",
      color: "analytics-green",
    },
    {
      icon: Eye,
      title: "Invisible Operation",
      description: "Runs silently in the background without affecting user experience.",
      color: "analytics-blue",
    },
  ];
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <a href="#setup" className="text-muted-foreground hover:text-foreground transition-colors">Setup</a>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Get deep insights into user behavior with heatmaps, funnel analysis, and real-time analytics. 
            Make data-driven decisions that boost conversions.
          </p>
      ...
      <section id="features" className="py-20 px-4 bg-muted/30">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">Powerful Analytics Features</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Everything you need to understand user behavior and optimize your website for better conversions.
            </p>
          </div>
            ...
            <Card className="bg-gradient-data border-0">
              <CardContent className="p-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                  <div>
                    <h3 className="text-2xl font-semibold mb-4">Copy & Paste Installation</h3>
                    <p className="text-muted-foreground mb-6">
                      Just add this script to your website and you're ready to go. No complex configuration needed.
                    </p>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center space-x-3">
                        <div className="w-8 h-8 bg-analytics-green/10 rounded-full flex items-center justify-center">
                          <span className="text-analytics-green font-semibold">1</span>
                        </div>
                        <span>Create your account</span>
                      </div>
                      <div className="flex items-center space-x-3">
                        <div className="w-8 h-8 bg-analytics-blue/10 rounded-full flex items-center justify-center">
                          <span className="text-analytics-blue font-semibold">2</span>
                        </div>
                      ...
                      <div className="flex items-center space-x-3">
                        <div className="w-8 h-8 bg-analytics-orange/10 rounded-full flex items-center justify-center">
                          <span className="text-analytics-orange font-semibold">3</span>
                        </div>
      ...
      <section id="pricing" className="py-20 px-4 bg-muted/30">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Start free, upgrade when you need more insights and history access.
            </p>
          </div>
      ...
      <section className="py-20 px-4 bg-gradient-hero text-white">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
            Join thousands of businesses already using InsightFlow to optimize their websites and boost conversions.
          </p>
